...
Selecionar a categoria da indicação

Inserir informações do indicado

Revisar todos os dados antes da confirmação final

O fluxo foi pensado para ser simples, responsivo e intuitivo.

🚀 Funcionalidades
📝 Formulário de Votação

O participante preenche seus dados e informa os dados da pessoa indicada.

🗂️ Abas de Categorias
